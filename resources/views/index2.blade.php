    ...
    <span class="hasImage"
          ...
          style="background-image: url('{{  asset(Storage::url($post->thumbnail_url)) }}');">
                                                                                                        ...
                                                                                                        <div class='postMeta'>
                                                                                                                  <div class='postAuthorAndTimestamp'>
                                                                                                                          <span class='authorImage'>
                                                                                                                                    <span class='hasImage'
                                                                                                                                            data-style='{{  asset(Storage::url($post->author->image_url)) }}' style="background-image: url('{{  asset(Storage::url($post->author->image_url)) }}');"></span>
                                                                                                                          </span>
                        ...
                        <aside class='aside wrapper'>
                                          ...
                                          <div class='widget-content'>
                                                <ul class='list hasIcons'>
                                                      <li class='hasIcon facebook'>
                                                            <a href='https://www.facebook.com/civilizationhasanath/'
                                                                  target='_blank'>
                                                      ...
                                                      <li class='hasIcon youtube'>
                                                            <a href='https://www.youtube.com/@civilizationhasanath'
                                                                  target='_blank'>
                                                                  Civilization Hasanath
                                                      ...
                                                      <li class='hasIcon instagram'>
                                                            <a href='https://www.instagram.com/civilization_hasanath/'
                                                                  target='_blank'>
                              ...
                              <div class='sidebar-3 sidebar no-items section' id='sidebar-3' name='Sidebar [Global]'<div class='sidebar-3 sidebar no-items section' id='sidebar-3' name='Sidebar [Global]'>
                                                            </div>
                                                                                    </aside>
                                                                                                      </div>
