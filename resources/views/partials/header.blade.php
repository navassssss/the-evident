<div class='settings section' id='settings' name='Settings'>
                              ...
                              <div class='widget-content hasLogo'>
                                    <a class='logo' href='{{ url('/') }}'>
                                          <img alt='The Evident' height='84' id='Image1_img'
                                                src='{{ asset('logocolor1.png') }}' width='132' />
                                    </a>
                  ...
                  <div class='header-mainbar-overlay'>
                        <div class='header-mainbar section' id='header-mainbar' name='Header Main Bar'>
                              ...
                              <div class='widget Header' data-version='2' id='Header1'>
                                    <a class='logo' href='{{ url('/') }}'>
                                          <img alt='The Evident' height='84' src='{{ asset('logocolor1.png') }}'
    ...
    <li class="hasMenu">
        <a href="{{ route('section.show', $section->slug) }}">
            {{ $section->name }}
        </a>
        ...
        @if($section->categories->count())
            <ul class="subMenu">
                @foreach($section->categories as $category)
                    <li class="subItem">
                        <a href="{{ route('category.show', $category->term) }}">
                            {{ $category->term }}
                        </a>
                    </li>
                @endforeach
